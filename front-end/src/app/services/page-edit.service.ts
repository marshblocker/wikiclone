...
export class PageEditService {
  ...
  getUserPageEdits = (
    ...
    return new Promise((resolve, reject) => {
      const url =
        'http://localhost:3000/page-edits?username=' +
        username +
        '&offset=' +
        offset +
        '&limit=' +
  ...
  getPageEditByPageTitleAndPageVersion = (
    pageTitle: string,
    pageVersion: string
  ): Promise<PageEdit> => {
    return new Promise((resolve, reject) => {
      const url =
        'http://localhost:3000/page-edits?page_title=' +
        pageTitle +
        '&page_version=' +
        pageVersion;
